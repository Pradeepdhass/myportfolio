      ...
      <div className="row g-4">
        ...
        <div className="col-md-6">
          <article className="project-card" data-reveal="">
            ...
            <div className="d-flex justify-content-between mb-3">
              ...
              <span
                style={{ color: "var(--color-cyan)", opacity: 0.4 }}
            ...
            <div className="d-flex gap-2">
              <span
                className="btn btn-sm btn-outline-light rounded-pill"
                aria-label="Live demo not yet available for MARKUS 2026"
                aria-disabled="true"
                style={{ borderColor: "var(--text-muted)", color: "var(--text-muted)", opacity: 0.5, cursor: "default" }}
              >
                Live Demo
              </span>
              <span
                className="btn btn-sm btn-outline-light rounded-pill"
                aria-label="Source code not yet available for MARKUS 2026"
                aria-disabled="true"
                style={{ background: "rgba(255,255,255,0.05)", borderColor: "var(--text-muted)", color: "var(--text-muted)", opacity: 0.5, cursor: "default" }}
              >
                <i className="fab fa-github" aria-hidden="true"></i> Code
              </span>
            </div>
        ...
        <div className="col-md-6">
          <article className="project-card" data-reveal="">
            ...
            <p className="small text-muted mb-3">
              A comprehensive mobile application for tracking departmental attendance and automatically calculating payroll based on logged hours and leaves.
            </p>
            <div className="mb-4" aria-label="Technologies used">
            ...
            <div className="d-flex gap-2">
              <span
                className="btn btn-sm btn-outline-light rounded-pill"
                aria-label="Source code not yet available for Attendance Tracking project"
                aria-disabled="true"
                style={{ background: "rgba(255,255,255,0.05)", borderColor: "var(--text-muted)", color: "var(--text-muted)", opacity: 0.5, cursor: "default" }}
              >
                <i className="fab fa-github" aria-hidden="true"></i> Code
