...
const Footer = () => {
  ...
  return (
    ...
    >
      <div className="footer-inner" data-reveal="">
        <div className="footer-col footer-brand">
          ...
          <p className="footer-desc">
            Full Stack Developer &amp; UI/UX Enthusiast specializing in the
            MERN Stack — crafting accessible, pixel-perfect digital experiences
      ...
      <p className="footer-copy">
        Full Stack Developer &amp; UI/UX Enthusiast — MERN Stack · Crafted by{" "}
        <strong>Pradeepdhass.R</strong> © <span>{year}</span>
      </p>
    </footer>
  );
};
