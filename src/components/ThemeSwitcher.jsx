  ...
  return (
    <>
      ...
      <div
        ...
        tabIndex={-1}
      >
        <button className="palette-swatch" data-accent="light" aria-label="Switch to light theme" role="menuitem" onClick={() => handleThemeChange('light')}>
          <span className="swatch-inner" style={{background: '#f0f2f5'}}></span>
        </button>
        <button className="palette-swatch" data-accent="pink" aria-label="Switch to pink theme" role="menuitem" onClick={() => handleThemeChange('pink')}>
          <span className="swatch-inner" style={{background: '#ff4db0'}}></span>
        </button>
        <button className="palette-swatch" data-accent="red" aria-label="Switch to red theme" role="menuitem" onClick={() => handleThemeChange('red')}>
          <span className="swatch-inner" style={{background: '#ff6b6b'}}></span>
        </button>
        <button className="palette-swatch" data-accent="green" aria-label="Switch to green theme" role="menuitem" onClick={() => handleThemeChange('green')}>
          <span className="swatch-inner" style={{background: '#10b981'}}></span>
        </button>
        <button className="palette-swatch" data-accent="cyan" aria-label="Switch to cyan theme" role="menuitem" onClick={() => handleThemeChange('cyan')}>
          <span className="swatch-inner" style={{background: '#06b6d4'}}></span>
        </button>
        <button className="palette-swatch" data-accent="purple" aria-label="Switch to purple theme" role="menuitem" onClick={() => handleThemeChange('purple')}>
